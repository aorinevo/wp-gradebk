(function($, Backbone, _, ANGradeBook) {
    'use strict';
    ANGradeBook.Views.EditAssignmentView = Backbone.View.extend({
        id: 'base-modal',
        ...
        render: function() {
            ...
            var self = this;
            _.defer(function() {
                self.inputName = self.$('input[name="assign_name"]');
                if (self.assignment) {
        ...
        editSave: function(ev) {
            ...
            if (toadd) {
                ...
                var toadds = new ANGradeBook.Models.Assignment(assignmentInformation);
                toadds.save(assignmentInformation, {
