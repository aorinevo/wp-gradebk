(function($, Backbone, _, ANGradeBook) {
    'use strict';
    ANGradeBook.Views.AssignmentView = Backbone.View.extend({
        tagName: 'th',
        ...
        editAssignment: function(ev) {
            ev.preventDefault();
            var view = new ANGradeBook.Views.EditAssignmentView({model: this.assignment, options: this.options});
        },
            ...
            this.assignment.destroy({
                success: function(model) {
                    ...
                    if (self.assignments.models.length) {
                        ...
                        for (var i = _x; i < _y.get('assign_order'); i++) {
