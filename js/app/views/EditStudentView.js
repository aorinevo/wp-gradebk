(function($, Backbone, _, ANGradeBook) {
    'use strict';
    ANGradeBook.Views.EditStudentView = Backbone.View.extend({
        id: 'base-modal',
        ...
        editSave: function(ev) {
            ...
            if (this.student) {
                ...
                var toadds = new ANGradeBook.Models.Student(studentInformation);
                toadds.save(studentInformation, {
