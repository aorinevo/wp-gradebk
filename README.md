...
src/
  ...
  components/
    ...
    CourseList/                  Course list table (wp-list-table, row-actions)
    GradebookTable/             Gradebook spreadsheet (inline editing, sort, filter)
